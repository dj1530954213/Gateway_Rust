  ...
  <div class="analytics-page">
    ...
    <div v-if="viewMode === 'dashboard'" class="dashboard-view">
      ...
      <div class="kpi-overview">
        <el-row :gutter="16">
          <el-col v-for="kpi in kpiMetrics" :key="kpi.id" :span="6">
                  ...
                  <div class="prediction-metrics">
                    ...
                    <div class="prediction-item">
                      ...
                      <div class="confidence-range">
                        {{ predictionConfidenceRange.min.toFixed(2) }} ~
                        {{ predictionConfidenceRange.max.toFixed(2) }}
                      </div>
                    </div>
                    ...
                    <div class="prediction-item">
                      ...
                      <el-tag :type="getRiskType(anomalyRisk)" size="small">
    ...
    <div v-else-if="viewMode === 'reports'" class="reports-view">
      ...
      <div class="reports-grid">
        <el-row :gutter="16">
          <el-col v-for="report in filteredReports" :key="report.id" :span="8">
            <el-card
              shadow="hover"
              class="report-card"
            ...
            >
              <div class="report-content">
                <div class="report-header">
                  ...
                  <el-dropdown
                    trigger="click"
                    @command="cmd => handleReportAction(cmd, report)"
                  >
                ...
                <div class="report-footer">
                  ...
                  <div class="report-actions">
                    <el-button
                      size="small"
                      text
                      @click.stop="handleRunReport(report)"
                    >
                      运行
                    </el-button>
                  </div>
    ...
    <div v-else-if="viewMode === 'custom'" class="custom-view">
      <div class="designer-layout">
        ...
        <div class="designer-canvas">
          ...
          <div class="canvas-area" @drop="handleCanvasDrop" @dragover.prevent>
...
import { TimeRangePicker, ChartContainer } from '../../components/business'
...
const numericDatapoints = computed(() => {
  return availableDatapoints.value.filter(
    dp => dp.dataType === 'float' || dp.dataType === 'integer'
  )
})
...
const filteredReports = computed(() => {
  ...
  return reports.value.filter(
    report =>
      report.title
        .toLowerCase()
        .includes(reportSearchText.value.toLowerCase()) ||
      report.description
        .toLowerCase()
        .includes(reportSearchText.value.toLowerCase())
  )
...
const handleDistributionDatapointChange = () => {
  const datapoint = availableDatapoints.value.find(
    dp => dp.id === selectedDistributionDatapoint.value
  )
...
const handlePredictionDatapointChange = () => {
  const datapoint = availableDatapoints.value.find(
    dp => dp.id === selectedPredictionDatapoint.value
  )
...
const handleSaveReport = async () => {
  ...
  try {
    if (!editingReport.value.id) {
      ...
      // 更新报表
      await analyticsApi.updateReport(
