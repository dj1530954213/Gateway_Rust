 ...
 */
function validateSingleRule(value: any, rule: ValidationRule): ValidationResult {
  // Required validation
 ...
 */
export function validateDriverConfig(config: any, driverType: string): ValidationResult {
  const baseRules = [
 ...
 */
export function validateConnectorConfig(config: any, connectorType: string): ValidationResult {
  const baseRules = [
    ValidationRules.required(),
  ]
...
export function validateDataPoint(dataPoint: any): ValidationResult {
  ...
  if (dataPoint.data_type && dataPoint.address) {
    const addressValidation = validateDataPointAddress(dataPoint.address, dataPoint.data_type)
 ...
 */
function validateDataPointAddress(address: string, dataType: string): ValidationResult {
