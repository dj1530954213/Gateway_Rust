      ...
      <div class="metric-card cpu">
        <div class="metric-header">
          ...
          <div class="metric-value">
            <span
              class="value-number"
              :class="getCpuStatusClass(metrics.cpu.usage)"
            >
              {{ metrics.cpu.usage }}%
            </span>
          </div>
        ...
        <div class="metric-header">
          ...
          <div class="metric-info">
            ...
            <div class="metric-subtitle">
              {{ formatFileSize(metrics.memory.total) }}
            </div>
          </div>
          <div class="metric-value">
            <span
              class="value-number"
              :class="getMemoryStatusClass(metrics.memory.usage)"
            >
        ...
        <div class="metric-details">
          <div class="detail-item">
            ...
            <span class="detail-value">{{
              formatFileSize(metrics.memory.used)
            }}</span>
          </div>
          <div class="detail-item">
            <span class="detail-label">可用:</span>
            <span class="detail-value">{{
              formatFileSize(metrics.memory.available)
            }}</span>
          </div>
          <div class="detail-item">
            <span class="detail-label">缓存:</span>
            <span class="detail-value">{{
              formatFileSize(metrics.memory.cached)
            }}</span>
          </div>
        </div>
      </div>
      ...
      <div class="metric-card disk">
        <div class="metric-header">
          ...
          <div class="metric-info">
            ...
            <div class="metric-subtitle">
              {{ formatFileSize(metrics.disk.total) }}
            </div>
          </div>
          <div class="metric-value">
            <span
              class="value-number"
              :class="getDiskStatusClass(metrics.disk.usage)"
            >
              {{ metrics.disk.usage }}%
            </span>
          </div>
        ...
        <div class="metric-details">
          <div class="detail-item">
            <span class="detail-label">已用:</span>
            <span class="detail-value">{{
              formatFileSize(metrics.disk.used)
            }}</span>
          </div>
          <div class="detail-item">
            <span class="detail-label">可用:</span>
            <span class="detail-value">{{
              formatFileSize(metrics.disk.available)
            }}</span>
          </div>
          <div class="detail-item">
      ...
      <div class="metric-card network">
            ...
            <div class="network-values">
              <div class="network-in">
                ...
                <span class="network-speed">{{
                  formatNetworkSpeed(metrics.network.in)
                }}</span>
              </div>
              <div class="network-out">
                <span class="network-label">↑</span>
                <span class="network-speed">{{
                  formatNetworkSpeed(metrics.network.out)
                }}</span>
              </div>
            </div>
          </div>
        ...
        <div class="network-chart">
          ...
          <div class="mini-chart">
            ...
            <svg width="100%" height="60" viewBox="0 0 200 60">
              <polyline
                :points="
                  generateNetworkPoints(metrics.network.history?.in || [])
                "
                fill="none"
                stroke="#67c23a"
                stroke-width="2"
              ...
              <polyline
                :points="
                  generateNetworkPoints(metrics.network.history?.out || [])
                "
                fill="none"
                stroke="#409eff"
                stroke-width="2"
        ...
        <div class="metric-details">
          ...
          <div class="detail-item">
            ...
            <span class="detail-value"
              >{{ metrics.network.latency || 0 }}ms</span
            >
          </div>
          <div class="detail-item">
            <span class="detail-label">丢包率:</span>
            <span class="detail-value"
              >{{ metrics.network.packetLoss || 0 }}%</span
            >
          </div>
        </div>
      </div>
      ...
      <div class="process-list">
        ...
        >
          ...
          <div class="process-col process-cpu">
            <span :class="{ 'high-usage': process.cpu > 50 }"
              >{{ process.cpu }}%</span
            >
          </div>
          <div class="process-col process-memory">
