      ...
      <el-card class="detail-card" shadow="never">
        ...
        <div class="detail-grid">
          ...
          <div class="detail-item">
            ...
            <span class="detail-value filepath">{{
              driver.file_path || '未指定'
            }}</span>
          </div>
          ...
          <div class="detail-item">
            ...
            <span class="detail-value">{{
              formatDateTime(driver.uploaded_at)
            }}</span>
          </div>
          ...
          <div class="detail-item">
            ...
            <span class="detail-value">
              {{
                driver.last_loaded_at
                  ? formatDateTime(driver.last_loaded_at)
                  : '从未加载'
              }}
            </span>
          </div>
      ...
      <el-card v-if="driver.info" class="detail-card" shadow="never">
        ...
        <div class="detail-grid">
          ...
          <div class="detail-item">
            ...
            <span class="detail-value version">{{
              driver.info.version || '未提供'
            }}</span>
          </div>
          ...
          <div class="detail-item">
            ...
            <el-tag
              v-if="driver.info.protocol"
              :type="getProtocolTagType(driver.info.protocol)"
            >
